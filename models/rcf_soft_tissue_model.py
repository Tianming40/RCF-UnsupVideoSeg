...
_DINO_ONLY_KWARGS = frozenset({
    ...
    'dino_channels',
    'use_dino_graph_fusion', 'dino_graph_input_size', 'dino_graph_grid_size',
    'dino_graph_num_eigvecs', 'dino_graph_proj_channels', 'dino_graph_feat_channels',
    'dino_graph_chunk_size',
    'use_dino_graph_estep_fusion', 'dino_graph_estep_input_size',
    'dino_graph_estep_grid_size', 'dino_graph_estep_num_eigvecs',
    'dino_graph_estep_chunk_size', 'dino_graph_estep_temperature',
    'dino_graph_estep_alpha',
    'use_dino_graph_fusion_deep', 'dino_graph_deep_input_size',
    'dino_graph_deep_grid_size', 'dino_graph_deep_num_eigvecs',
    'dino_graph_deep_proj_channels', 'dino_graph_deep_feat_channels',
    'dino_graph_deep_chunk_size',
    'use_dino_graph_attention_gate', 'dino_graph_gate_input_size',
    'dino_graph_gate_grid_size', 'dino_graph_gate_num_eigvecs',
    'dino_graph_gate_hidden_channels', 'dino_graph_gate_feat_channels',
    'dino_graph_gate_chunk_size',
    'use_dino_graph_fusion_deep2', 'dino_graph_deep2_input_size',
    'dino_graph_deep2_grid_size', 'dino_graph_deep2_num_eigvecs',
    'dino_graph_deep2_proj_channels', 'dino_graph_deep2_feat_channels',
    'dino_graph_deep2_chunk_size',
    'use_dino_graph_decoder_prior', 'dino_prior_input_size',
    'dino_prior_grid_size', 'dino_prior_num_eigvecs', 'dino_prior_chunk_size',
    'use_dino_graph_bayesian_prior', 'dino_bayes_input_size',
    'dino_bayes_grid_size', 'dino_bayes_num_eigvecs', 'dino_bayes_temperature',
    'dino_bayes_chunk_size',
})
