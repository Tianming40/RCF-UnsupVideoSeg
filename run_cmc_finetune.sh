...
#SBATCH --job-name=rcf_cmc_finetune
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=16
#SBATCH --mem=64G
#SBATCH --time=24:00:00
#SBATCH --output=slurm_rcf_cmc_finetune_%j.out
...
echo "=========================================="
echo "Fine-tuning on CMC_grasp10 (resumed from data_medical checkpoint)"
echo "Started at: $(date)"
echo "=========================================="

TIMESTAMP=$(date +%m%d_%H%M%S)
RUN_DIR="saved/saved_cmc_finetune_${TIMESTAMP}"

echo "Checkpoint dir: ${RUN_DIR}"

CUDA_VISIBLE_DEVICES=0 python main.py \
    configs/instrument/rcf_cmc_finetune.yaml \
